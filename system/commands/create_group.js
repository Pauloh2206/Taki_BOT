...
module.exports = {
    ...
    callback: async ({ sock, m }) => {        
        ...
        let teks = "\`\`\`「  MENSAGEM DO GRUPO DE CRIAÇÃO  」\`\`\`\n\n"
        teks += `▸ Nome : ${create.subject}\n`
        teks += `▸ Proprietário : @${create.owner.split("@")[0]}\n`
        teks += `▸ Criação : ${moment(create.creation * 1000).tz("Asia/Jakarta").format("DD/MM/YYYY HH:mm:ss")}\n`        
