...
module.exports = {
    ...
    callback: async ({ m }) => {
        ...
        teks += `│⭔ config : ${parseFloat(stdout.split("config")[0])} ${stdout.split("config")[0].includes("G")? "GB" : stdout.split("config")[0].includes("M")? "MB" : "KB"}\n`
        teks += `│⭔ connections : ${parseFloat(stdout.split("connections")[0].split("config")[1])} ${stdout.split("connections")[0].split("config")[1].includes("G")? "GB" : stdout.split("connections")[0].split("config")[1].includes("M")? "MB" : "KB"}\n`
        ...
        teks += `│⭔ store : ${parseFloat(stdout.split("store")[0].split("settings.json")[1])} ${stdout.split("store")[0].split("settings.json")[1].includes("G")? "GB" : stdout.split("store")[0].split("settings.json")[1].includes("M")? "MB" : "KB"}\n`
        teks += `│⭔ system : ${parseFloat(stdout.split("system")[0].split("store")[1])} ${stdout.split("system")[0].split("store")[1].includes("G")? "GB" : stdout.split("system")[0].split("store")[1].includes("M")? "MB" : "KB"}\n`
